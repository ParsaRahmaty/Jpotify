...
public class East extends JPanel {
    ...
    public void addFriend(String name, String songName, String artistName, int timeAgo) {
        ...
        JLabel songNameLabel = makeLabel(songName);
        JLabel artistNameLabel = makeLabel(artistName);
        JLabel timeLabel;
        if (timeAgo != 0)
            timeLabel = makeLabel(timeAgo + " ago");
        else
